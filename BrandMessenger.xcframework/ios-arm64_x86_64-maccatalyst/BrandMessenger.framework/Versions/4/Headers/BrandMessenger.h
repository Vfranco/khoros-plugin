...
#import "KBMConversation.h"
#import "KBMSettings.h"
#import "KBMUser.h"
#import "KBMParticipant.h"
#import "KBMConversationListDelegate.h"

NS_ASSUME_NONNULL_BEGIN
@protocol UNUserNotificationCenterDelegate;

#define BRANDMESSENGER_VERSION @"4.1.1"
#define VENDOR_ID @"brandMessenger"

FOUNDATION_EXPORT double BrandMessengerVersionNumber;
FOUNDATION_EXPORT const unsigned char BrandMessengerVersionString[];

/**
 *  @abstract User info dictionary key to determine the origin of a push notification.
 *
 *  @discussion Push notifications that originate from BrandMessenger will have a non-nil value for this key.
 *
 *  `BOOL isBrandMessengerNotification = userInfo[KBMPushNotificationIdentifier] != nil`
 */
extern NSString* const KBMPushNotificationIdentifier;

/**
 *  @abstract User info dictionary key for an KBMUser after a successful call to +login:jwt:completionHandler:
 *
 *  @see KBMUser
 *  @see KBMLoginDidCompleteNotification
 *  @see +login:jwt:completionHandler:
 */
extern NSString* const KBMUserIdentifier;

/**
 *  @abstract User info dictionary key for an KBMConversation after a successful call to +startConversationWithCompletionHandler:
 *
 *  @see KBMConversation
 *  @see +startConversationWithCompletionHandler:
 */
extern NSString* const KBMConversationIdentifier;
 ...
 *
 *  @see KBMInitializationDidFailNotification
 *  @see KBMLoginDidFailNotification
 *  @see KBMLogoutDidFailNotification
 *  @see +initWithSettings:completionHandler:
 *  @see +login:jwt:completionHandler:
 *  @see +logoutWithCompletionHandler:
 */
extern NSString* const KBMErrorCodeIdentifier;
 ...
 *  @see +logoutWithCompletionHandler:
 */
extern NSString* const KBMErrorDescriptionIdentifier;

/**
 *  @abstract Custom error domain identifier
 */
extern NSString* const KBMErrorDomainIdentifier;
 ...
 *  @see +logoutWithCompletionHandler:
 */
extern NSString* const KBMStatusCodeIdentifier;

/**
 *  @abstract Identifier for a BrandMessenger user notification reply action.
 *
 ...
 */
extern NSString* const KBMUserNotificationReplyActionIdentifier;

/**
 *  @abstract Identifier for a BrandMessenger user notification category.
 *
 ...
 */
extern NSString* const KBMUserNotificationReplyCategoryIdentifier;
 ...
 *  @see +initWithSettings:completionHandler:
 */
extern NSString* const KBMInitializationDidCompleteNotification;
 ...
 *
 *  @see KBMErrorCodeIdentifier
 *  @see KBMErrorDescriptionIdentifier
 *  @see KBMStatusCodeIdentifier
 */
extern NSString* const KBMInitializationDidFailNotification;
 ...
 *
 *  @see +login:jwt:completionHandler:
 *  @see KBMUserIdentifier
 */
extern NSString* const KBMLoginDidCompleteNotification;
 ...
 *  @see KBMStatusCodeIdentifier
 */
extern NSString* const KBMLoginDidFailNotification;
 ...
 *  @see +logoutWithCompletionHandler:
 */
extern NSString* const KBMLogoutDidCompleteNotification;
 ...
 *  @see KBMStatusCodeIdentifier
 */
extern NSString* const KBMLogoutDidFailNotification;

/**
 *  @abstract The core class used for interacting with BrandMessenger. Provides methods to initialize, configure, and interact with the library.
 */
@interface BrandMessenger : NSObject

/**
 *  @abstract Initialize the BrandMessenger SDK with the provided settings.
 *
 ...
 */
+(void)initWithSettings:(KBMSettings*)settings completionHandler:(nullable void(^)(NSError * _Nullable error, NSDictionary * _Nullable userInfo))handler;
 ...
 */
+(nullable KBMSettings*)settings;

/**
 *  @abstract Presents the BrandMessenger conversation screen.
 *
...
/**
 *  @abstract Loads the conversation specified by the ID, and presents the BrandMessenger conversation screen
 *
 *  @discussion Uses the top-most view controller of the `UIApplicationDelegate` as the presenting view controller.
 *
 *  +initWithSettings:completionHandler: must have been called prior to calling this method.
...
/**
 *  @abstract Presents the BrandMessenger conversation screen with prefilled text in the message input.
 *
...
/**
 *  @abstract Loads the conversation specified by the ID, and presents the BrandMessenger conversation screen with prefilled text in the message input.
 *
 *  @discussion Uses the top-most view controller of the `UIApplicationDelegate` as the presenting view controller with prefilled text in the message input.
 *
 *  +initWithSettings:completionHandler: must have been called prior to calling this method.
...
/**
 *  @abstract Dismisses the BrandMessenger conversation, if shown.
 *
...
/**
 *  @abstract Destroys the BrandMessenger SDK
 *
 *  @discussion BrandMessenger is automatically terminated when the application exits. This method does not need to be called manually
 *
 */
+(void)destroy;

/**
 *  @abstract Presents the BrandMessenger conversation screen, using the given view controller as presenting view controller.
 *
...
/**
 *  @abstract Loads the conversation specified by the ID, and presents the BrandMessenger conversation screen, using the given view controller as presenting view controller.
 *
 *  @discussion In most cases, it is better to use +show. If you need more fine-grained control over which view controller is used as presenting view controller, use this method instead.
 *
 *  +initWithSettings:completionHandler: must have been called prior to calling this method.
...
/**
 *  @abstract Presents the BrandMessenger conversation screen, using the given view controller as presenting view controller with prefilled text in the message input.
 *
 *  @discussion In most cases, it is better to use +show. If you need more fine-grained control over which view controller is used as presenting view controller, use this method instead.
 *
 *  +initWithSettings:completionHandler: must have been called prior to calling this method.
...
/**
 *  @abstract Loads the conversation specified by the ID, and presents the BrandMessenger conversation screen, using the given view controller as presenting view controller with prefilled text in the message input.
 *
 *  @discussion In most cases, it is better to use +show. If you need more fine-grained control over which view controller is used as presenting view controller, use this method instead.
 *
 *  +initWithSettings:completionHandler: must have been called prior to calling this method.
...
/**
 *  @abstract Creates and returns a BrandMessenger conversation view controller.
 *
 ...
 *
 *  @return A new instance of the BrandMessenger conversation view controller class. Returns nil if +initWithSettings:completionHandler: hasn't been called
 */
+(nullable UIViewController*)newConversationViewController;

/**
 *  @abstract Creates and returns a BrandMessenger conversation view controller, loading the conversation specified by the ID
 *
 *  @discussion You may use this view controller to embed the conversation in a navigation controller, to change the modal presentation style, or display it in any way you choose.
 *
 *  Note: It is the responsibility of the caller to show, hide, and maintain a reference to this view controller. Calling `close` will not dismiss a view controller created in this way.
...
/**
 *  @abstract Creates and returns a BrandMessenger conversation view controller with prefilled text in the message input.
 *
...
/**
 *  @abstract Creates and returns a BrandMessenger conversation view controller with prefilled text in the message input, loading the conversation specified by the ID
 *
 *  @discussion You may use this view controller to embed the conversation in a navigation controller, to change the modal presentation style, or display it in any way you choose. The message input will be prefilled with the given `startingText`
 *
 *  Note: It is the responsibility of the caller to show, hide, and maintain a reference to this view controller. Calling `close` will not dismiss a view controller created in this way.
...
/**
 *  @abstract Presents the BrandMessenger conversation list screen.
 *
 *  @discussion Uses the top-most view controller of the `UIApplicationDelegate` as the presenting view controller.
 *
 *  +initWithSettings:completionHandler: must have been called prior to calling this method.
...
/**
 *  @abstract Presents the BrandMessenger conversation list screen without a create conversation button
 *
 *  @discussion Uses the top-most view controller of the `UIApplicationDelegate` as the presenting view controller.
 *
 *  +initWithSettings:completionHandler: must have been called prior to calling this method.
...
/**
 *  @abstract Dismisses the BrandMessenger conversation list, if shown.
 *
 *  @discussion Note: If a view controller was created and presented using `newConversationViewController`, calling this method will have no effect.
 *
 *  +initWithSettings:completionHandler: must have been called prior to calling this method.
...
/**
 *  @abstract Presents the BrandMessenger conversation list screen, using the given view controller as presenting view controller.
 *
 *  @discussion In most cases, it is better to use +show. If you need more fine-grained control over which view controller is used as presenting view controller, use this method instead.
 *
 *  +initWithSettings:completionHandler: must have been called prior to calling this method.
...
/**
 *  @abstract Presents the BrandMessenger conversation list screen without a create conversation button, using the given view controller as presenting view controller.
 *
 *  @discussion In most cases, it is better to use +show. If you need more fine-grained control over which view controller is used as presenting view controller, use this method instead.
 *
 *  +initWithSettings:completionHandler: must have been called prior to calling this method.
...
/**
 *  @abstract Creates and returns a BrandMessenger conversation list view controller.
 *
 *  @discussion You may use this view controller to embed the conversation in a navigation controller, to change the modal presentation style, or display it in any way you choose.
 *
 *  A view controller created in this way is tied to the current user's conversation at creation time. If the current user changes (i.e. by calling +login:jwt:completionHandler: or +logoutWithCompletionHandler:), the view controller is invalidated and must be recreated for the new user.
...
/**
 *  @abstract Creates and returns a BrandMessenger conversation list view controller without a create conversation button.
 *
 *  @discussion You may use this view controller to embed the conversation in a navigation controller, to change the modal presentation style, or display it in any way you choose.
 *
 *  A view controller created in this way is tied to the current user's conversation at creation time. If the current user changes (i.e. by calling +login:jwt:completionHandler: or +logoutWithCompletionHandler:), the view controller is invalidated and must be recreated for the new user.
 ...
 *
 *  @see KBMConversationListDelegate
 *
 *  @param delegate Can we an object conforming to KBMConversationListDelegate, or NULL, which would remove any existing delegate
 */
+(void)setConversationListDelegate:(nullable id<KBMConversationListDelegate>)delegate;

/**
 *  @abstract Sets the current user's first and last name to be used as a display name when sending messages.
 *
 *  @discussion This is a shortcut for -setFirstName and -setLastName on `[KBMUser currentUser]`
 *
 *  @see KBMUser
 *
 ...
 */
+ (nullable KBMConversation *)conversation;
 ...
 */
+ (void)conversationById:(NSString *)conversationId completionHandler:(nullable void(^)(NSError * _Nullable error, KBMConversation * _Nullable conversation))handler;

/**
 *  @abstract Logs in a new BrandMessenger user.
 *
 ...
 * @param message An array containing a single KBMMessage type, to be sent as part of conversation creation. Only a message of type text can be sent as part of conversation creation. Multiple messages, or other types (e.g files, attachments) will cause this method to return an error.
 * @param completionHandler An optional block to evaluate the result of the operation
 */

+(void)createConversationWithName:(nullable NSString *)displayName description:(nullable NSString *)description iconUrl:(nullable NSString *)iconUrl avatarUrl:(nullable NSString *)avatarUrl metadata:(nullable NSDictionary *)metadata message:(nullable NSArray<KBMMessage *> *)message completionHandler:(nullable void(^)(NSError * _Nullable error, NSDictionary * _Nullable userInfo))completionHandler;
 ...
 *
 *  @discussion This method is called automatically if KBMSettings.enableAppDelegateSwizzling is set to YES.
 *
 *  @see KBMSettings
 */
 ...
 *  {
 *    if(notification.request.content.userInfo[KBMPushNotificationIdentifier] != nil){
 *      [[BrandMessenger userNotificationCenterDelegate] userNotificationCenter:center willPresentNotification:notification withCompletionHandler:completionHandler];
 *      return;
 *    }
 *  }
 *
 ...
 *  {
 *    if(response.notification.request.content.userInfo[KBMPushNotificationIdentifier] != nil){
 *      [[BrandMessenger userNotificationCenterDelegate] userNotificationCenter:center didReceiveNotificationResponse:response withCompletionHandler:completionHandler];
 *      return;
 *    }
 *  }
 *
...
/**
 *  @abstract A set of categories used for handling and displaying BrandMessenger user notification actions.
 *
 ...
 *
 * @discussion Returns a list of KBMConversation objects from storage.
 *
 */
 ...
 */
+ (void)updateConversationDelegate:(id<KBMConversationDelegate>)delegate;
...
/**
 *  @abstract Reloads the conversation on current shown viewcontroller
 *
 *  @discussion If conversation was shown throw BrandMessenger.show() and is currently shown, this should be called after a reauthentication occurs through authenticationDelegate.onInvalidToken.
 *  The reauth recreates the dependencies and loses connection to any current view controllers, needs to be manually reconnected after reauth.
 *
 */
+ (void)reloadShownConversationViewController:(UIViewController*)viewController;
